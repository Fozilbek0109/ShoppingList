...
class EditShopItemUseCase @Inject constructor(private val repository: ShopItemRepository) {
    operator fun invoke(shopItem: ShopItem) = repository.editShopItem(shopItem)
